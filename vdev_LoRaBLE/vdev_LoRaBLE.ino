...
void UpdateClient(void)
{
  ...
  static const unsigned char PROGMEM image_charging_Saraarray[] = {
    ...
    display.print(Line);
    sprintf(Line2, "Battery: ", batpecnt);
    display.setCursor(60,20);
    display.print(Line2);
    if (power.isCharging() ? "YES" : "NO ")
    {
      display.drawBitmap(50, 50, image_charging_Saraarray, 15, 16, 1);
    }
    else
    {
      display.drawBitmap(50, 50, image_blnk_Saraarray, 15, 16, 1);
    }
    display.display();
  #endif    
