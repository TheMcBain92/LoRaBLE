...
void setup()
{
  ...
  // EEPROM
    ...
    Serial.printf("DCDC1: %s\n", power.isEnableDC1() ? "ENABLE" : "DISABLE");
    Serial.printf("DCDC2: %s\n", power.isEnableDC2() ? "ENABLE" : "DISABLE");
    Serial.printf("LDO2: %s\n", power.isEnableALDO2() ? "ENABLE" : "DISABLE");
    Serial.printf("LDO3: %s\n", power.isEnableALDO3() ? "ENABLE" : "DISABLE");
    Serial.printf("DCDC3: %s\n", power.isEnableDC3() ? "ENABLE" : "DISABLE");
  #endif
    ...
    {
      Serial.println("AXP202 Begin FAIL");
    }  
  ...
  // OLED
    ...
    display.print("LoRa Receiver V1.1");
